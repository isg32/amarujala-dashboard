...
// Pill-shaped buttons (rounded-full) are the one non-negotiable brand
// element per DESIGN.md — every other surface (cards, inputs, popovers)
// keeps the default 6px --radius, only interactive buttons go full pill.
